...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'https://www.anahaimu.store/api'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'https://www.anahaimu.store/api'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'https://www.anahaimu.store/api'
