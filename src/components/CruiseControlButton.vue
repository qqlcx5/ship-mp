<template>
  <view class="cruise-button-wrapper">
    <button 
      class="cruise-button"
      :class="colorClass"
      @click="handleClick"
...
.cruise-button {
  ...
  &.color-blue {
    background: linear-gradient(to right, #4FD1C7, #2DD4BF);
    
    &:hover {
      background: linear-gradient(to right, #7DD3FC, #4FD1C7);
    }
  }
